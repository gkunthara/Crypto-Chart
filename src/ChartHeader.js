          ...
          <Col style={{ marginLeft: 15, marginTop: 5 }}>
            <ButtonGroup>
              <Link to={this.props.location}>
                <Button ghost>1m</Button>
              </Link>
              <Link to={`${this.props.location}/7day`}>
                <Button ghost>7d</Button>
              </Link>
              <Link to={`${this.props.location}/1day`}>
                <Button ghost>1d</Button>
              </Link>
            </ButtonGroup>
          </Col>
        </Row>
